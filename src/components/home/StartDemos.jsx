          ...
          <div className="bord pt-25 bord-thin-top d-flex align-items-center">
            <h2 className="d-rotate wow md-mb15">
              {/* <span className="rotate-text">
                <span className="spc-font">15+ Companies - </span>
            ...
            <div className="ml-auto">
              <div className="filtering">
                <div className="filter">
                  ...
                  <span dataFilter=".light">Designs</span>
                  <span dataFilter=".light">Custom Softwares</span>

                  <span dataFilter=".light">Social Media Marketing</span>
                  <span dataFilter=".light">Content Creating</span>
                  <span dataFilter=".light">Video Editing</span>
                  <span dataFilter=".light">Mobile App</span>
